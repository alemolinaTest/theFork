...
data class TagList537(
    ...
    @SerializedName("id_city_indexable") var idCityIndexable: Int? = null,
    ...
    @SerializedName("display_order") var displayOrder: String? = null,
    @SerializedName("is_displayed_search") var isDisplayedSearch: Boolean? = null,
    @SerializedName("search_volume") var searchVolume: String? = null,
    ...
    @SerializedName("id_country_restriction") var idCountryRestriction: Int? = null,
